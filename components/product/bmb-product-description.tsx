        ...
        {quantities.map((qty, index) => (
          ...
          >
            ...
            <div className="text-xs">
              <Price amount={prices[index]} currencyCode={currencyCode} />
      ...
      {selectedQuantity >= 0 && (
        <div className="mt-4 rounded-md bg-neutral-50 p-3 dark:bg-neutral-800">
          <div className="flex justify-between text-sm">
            ...
            <span>Per unit: <Price amount={prices[selectedQuantity]} currencyCode={currencyCode} /></span>
          </div>
          <div className="mt-1 text-lg font-semibold">
            Total: <Price 
              amount={(parseFloat(prices[selectedQuantity]) * parseInt(quantities[selectedQuantity])).toFixed(2)} 
      ...
      <div className="py-4">
        {activeTab === 'specs' && (
          <div className="space-y-2 text-sm">
            {size && (
              <div className="flex">
                <span className="w-24 font-medium text-neutral-600 dark:text-neutral-400">Size:</span>
                <span>{size}</span>
              </div>
            )}
            {productionTime && (
              <div className="flex">
                <span className="w-24 font-medium text-neutral-600 dark:text-neutral-400">Production:</span>
